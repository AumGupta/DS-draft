...
class Slist
{
	...
	public:
		...
		T delete_tail();
		bool search(T el);
		Slist<T>& operator + (const Slist &obj2);
		Slist<T>& operator = (const Slist &obj2);
...
template <class T> 
Slist<T> &Slist<T> :: operator + (const Slist &obj2)
{
	node <T> *p;
	p = head;
	while(p -> next != NULL)
...
int main()
{
	//Enter the elements for first linked - list using the menu driven program.
	...
	cout<<"*   08) Remove an element with a specific value.                           	*"<<endl;
	cout<<"*   09) Display the linked list.                                           	*"<<endl;    
	cout<<"*   10) Reverse the linked list.                                            	*"<<endl;     
	cout<<"*   11) Count the number of elements in the linked list.                   	*"<<endl;
	cout<<"*   12) Concatenate two linked lists by overloading plus(+) operator.      	*"<<endl;
	cout<<"*   13) Concatenate two linked lists by overloading assignment(=) operator.	*"<<endl;
	cout<<"* -------------------------------------------------------------------------- *"<<endl;
	cout<<endl;
	
	Slist<int> obj,obj2,obj3;
	int k;
	int val,loc;
	...
	do{
		...
		switch(k){
			...
			case 8:{cout<<"Enter an element which you want to delete: ";
			        cin>>val;
			    	obj.delete_node(val);
			    	cout<<endl;
			...
			case 9:{cout<<"First singly linked list is: ";
			        obj.display();
				    cout<<endl;
				    cout<<"Second singly linked list is: ";
			        obj2.display();
				    cout<<endl;
				    cout<<"Third singly linked list is: ";
			        obj3.display();
				    cout<<endl;
				     break;
			}
			case 10:{obj.reverse();
					obj2.reverse();
					obj3.reverse();
					 cout<<"Press '09' to see the reversed list.";
			         cout<<endl;
				     break;
			}
			...
			case 12:{cout<<"Concate two linked lists and store result in the first list: ";
					obj = obj2;
					cout<<endl;
		   			break;
			}
			case 13:{cout<<"Concate two linked lists and store result in the first list: ";
					obj3 + obj2;
					cout<<endl;
		   			break;
			}
